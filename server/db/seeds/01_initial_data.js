export async function seed(knex) {
  ...
  //   Own fleet (no carrier): d_01↔d_02 (team), d_03, d_04, d_05, d_06
  //   Agro Transporta (7):   d_07↔d_08 (team)
  ...
  //   Own fleet: v_01 (d_01+d_02 team), v_02 (spare after d_02 teams up), v_03–v_06
  //   Agro Transporta (7): v_07 (d_07+d_08 team), v_08 (spare)
  //   Hunter Transport (6): v_09 (d_09+d_10 team), v_10 (spare)
  await knex('vehicles').insert([
    { id: 'v_01', unit_number: 'T-101', type: 'TRACTOR', make: 'Freightliner', model: 'Cascadia', year: 2022, vin: '3AKJHHDR5NSLA0001', license_plate: 'TX-TRK-1234', license_state: 'TX', status: 'ACTIVE', current_driver_id: 'd_01', current_driver2_id: 'd_02' },
    { id: 'v_02', unit_number: 'T-102', type: 'TRACTOR', make: 'Kenworth', model: 'T680', year: 2023, vin: '1XKYD49X0NJ100002', license_plate: 'CA-TRK-5678', license_state: 'CA', status: 'ACTIVE' },
