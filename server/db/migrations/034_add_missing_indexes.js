...
export async function up(knex) {
  await knex.raw('CREATE INDEX ix_loads_sales_agent_id ON loads (sales_agent_id)');
  ...
  await knex.raw('CREATE INDEX ix_loads_status ON loads (status)');
...
export async function down(knex) {
  await knex.raw('DROP INDEX IF EXISTS ix_loads_sales_agent_id');
